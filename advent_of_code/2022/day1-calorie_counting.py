...
# sum the subarrays and print the max value
elves = []
for elf in calories:
    elves.append(elf.sum())
print("Part 1 Solution: ", max(elves))

# Now we need the summed calorie counts for the three elves carring the most calories:
elves.sort(reverse=True)
print("Part 2 Solution: ", sum(elves[0:3]))
